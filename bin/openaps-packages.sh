...
## Debian Bullseye or later (Raspberry Pi OS 64bit, etc) is python3 by default and does not support python2-pip.
if [[ "$(. /etc/os-release && echo "${VERSION_ID:-0}")" -lt 11 ]]; then
